...
## Aim & Abstract
Meeting summarizer to generate important points and actionables from any meeting, lecture and transcript. Provide access to the same functionality across all platforms (Web, Desktop, Mobile Application and Browser Extension) 
